  ...
  return (
    <Section>
      <Card className='values-card text-center'>
        <Card.Body>
          <Card.Title>
            <img src='images/svg/color/011-medal.svg'/>
              &nbsp;&nbsp;&nbsp;Our Values&nbsp;&nbsp;&nbsp;
            <img src='images/svg/color/011-medal.svg'/>
          </Card.Title>
          <Container fluid>
            <Row className='values-row'>
              <Col xs='12' sm='6' md='4' lg='auto'>
                <Card className='text-center'>
                  ...
                  >
                    <div><img src='/images/svg/black-white/032-puzzle-1.svg' alt="collaboration"/></div>
                  </OverlayTrigger>
                  <Card.Body>
              ...
              <Col xs='12' sm='6' md='4' lg='auto'>
                <Card>
                  ...
                  >
                    <div><img src='/images/svg/black-white/048-recycle.svg' alt="sustainability"/></div>
                  </OverlayTrigger>
                  <Card.Body>
              ...
              <Col xs='12' sm='6' md='4' lg='auto'>
                <Card>
                  ...
                  >
                    <div><img className='iconAdjust' src='/images/svg/black-white/001-group.svg' alt="local action"/></div>
                  </OverlayTrigger>
                  <Card.Body>
              ...
              <Col xs='12' sm='6' md='4' lg='auto'>
                <Card>
                  ...
                  >
                    <div><img className='learn iconAdjust' src='/images/svg/black-white/024-book-1.svg' alt="education"/></div>
                  </OverlayTrigger>
                  <Card.Body>
              ...
              <Col xs='12' sm='6' md='4' lg='auto'>
                <Card>
                  ...
                  >
                    <div><img src='/images/svg/black-white/041-magic-wand.svg' alt="wonder and awe"/></div>
                  </OverlayTrigger>
                  <Card.Body>
