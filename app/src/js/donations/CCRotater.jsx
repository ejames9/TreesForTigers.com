...
// State obj...
    this.state = {
      currentIndex: 0,
      currentImage: `${pub}/images/svg/color/credit-cards/007-discover.svg`
...
// Method for rotating the address of the 4th cc image....
  rotateImage() {
    ...
    this.setState({
      currentIndex: idx,
      currentImage: `${pub}/images/svg/color/credit-cards/${this.imageAddresses[idx]}.svg`
    })
  }
...
// Component markup....
  render() {
    ...
    return (
      <React.Fragment>
        <img src={`${pub}/images/svg/color/credit-cards/003-mastercard-1.svg`} className="mastercard"/>
        <img src={`${pub}/images/svg/color/credit-cards/002-visa.svg`} className="visa"/>
        <img src={`${pub}/images/svg/color/credit-cards/001-amex.svg`} className="amex"/>
