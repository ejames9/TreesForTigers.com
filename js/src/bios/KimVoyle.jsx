...
import {kimVoyleBio} from '../textContent'
...
// Cover backdrop
const coverOverlay = '/images/tigerSkin01.jpg'
const coverOverlayPortrait = '/images/tigerSkin02.jpg'
// Kim Voyle photo....
const kimVoyle = '/images/kimVoyle.jpg'
...
class KimVoyleBio extends React.Component {
// Ctor...
  constructor() {
    super()
// Bind methods...
...
//styles[i].sheet.insertRule("#dummy { color: white }", 0);
// styles[i].sheet.addRule("#dummy", "color: white;", -1);
// log('hello')
