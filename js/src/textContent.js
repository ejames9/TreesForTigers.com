...
const disposableChopsticks = `While poaching and game hunting threatens tigers in other parts of the world, the biggest threat to Tigers in Eastern Russia is disposable chopsticks! Tiger habitat is being destroyed by both legal and illegal logging. Trees are harvested, shipped across the border to China, and then sold largely to Japan, although many are also     shipped to the US for use in Oriental themed restaurants. While tigers don't directly need trees to survive, their primary food source, the wild boar need nut bearing trees to flourish. In the Amur Valley region these are primarily four trees:
