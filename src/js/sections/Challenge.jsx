...
const imageOverlay = 'images/tigers/amurTigerRight.jpg'
const imageOverlayPortrait = 'images/tigers/amurTigerPortraitRight.jpg'
      ...
      <Container>
        ...
        <Row className='chopsticks'>
          <Col className='chops-img' xs='0' md='6'>
            <img className='hand' src='images/chopsticks/handChopsticks2.png'/>
          </Col>
          <Col className='chops-text' xs='12' md='6'>
            <Card className='disposable-chops text-center'>
              ...
              <Card.Img src='images/chopsticks/chopsticks04.png'/>
            </Card>
          </Col>
        </Row>
      </Container>
