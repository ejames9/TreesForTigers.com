...
// Cover backdrop
const coverOverlay = '/images/svg/black-white/landscapes/branches.svg'
const coverOverlayPortrait = '/images/tigers/tigerSkin02.jpg'
const tigerPNG = '/images/tigers/stalkingTiger0.png'
const moon = '/images/graphics/moon.png'
...
const Twinkling = styled.div`
  ...
  width: 100%;
  height: 60%;
  background: transparent url(/images/graphics/twinkler.png) repeat top center;
  z-index: 1000;
  pointer-events: none;
...
const Clouds = styled.div`
  ...
  height: 75%;
  opacity: .8;
  background: transparent url(/images/graphics/clouds.png) repeat top center;
  z-index: 1004;
  ...
  dayBreaker(y) {
    if (!this.props.stillNight) {
      ...
      if (percent <= 80) {
        ...
        this.twinkle.current.style.background = `transparent url(/images/graphics/twinkler.png) repeat top center`
...
// Method for changing aesthetic from day to night....
  eveDropper() {
    ...
    this.twinkle.current.style.background = `transparent url(/images/graphics/twinkler000.png) repeat top center`
    ...
    dawn
      ...
      .onUpdate(()=> {
        ...
        if (obj2.x <= 80) {
          ...
          twinkle.style.background = `transparent url(/images/graphics/twinkler.png) repeat top center`
        }
      })
