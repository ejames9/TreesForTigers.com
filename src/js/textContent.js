...
const ccIconAddresses = [
  "/images/svg/color/credit-cards/007-discover.svg", "/images/svg/color/credit-cards/004-diners-club.svg", "/images/svg/color/credit-cards/005-jcb.svg"
]
    ...
    <UL>
      <li className='navHome' >
        <HomeButton className='home-button' onClick={onClick}>
          <img src="/images/logos/trees4TigersLogoWhite.svg" alt="Trees for Tigers Logo"/>
        </HomeButton>
      ...
      <li className='imgLI'>
        <img className='amurEyes' src='/images/tigers/amurEyes.jpg'/>
      </li>
      <li>
